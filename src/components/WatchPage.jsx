...
const WatchPage = () => {
  ...
  return (
    <div className='m-10 flex flex-col gap-2 w-full'>
      <div className='flex w-full'>
        <iframe className='rounded-lg w-3/4' width="100%" height="800" src={`https://www.youtube.com/embed/${videoId}?si=zQe7FyfDV_gYiY8m&autoplay=1`} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        <LiveChat />
      </div>
